...
namespace ZacharyFaulk_CECS545_P4
{
    class Program
    {
        [STAThread]
        static void Main(string[] args)
        {
            ...
            string fileName = "Random100.TSP";    //File name being tested
            ...
            Application.Run(new P4_GUI(cityArray, globalVars.shortList));
    ...
    public class globalVars
    {
        ...
        public int pmx = 20;                //Size of the path that will swapped with the pmx crossover
